import DynamicGamesTheoremCanonicalLaneLean.ReviewerBridge
...
def sourceRepository : String := "dynamic-games-theorem-canonical-lane"
def sourceDescription : String := "Dynamic Games Theorem"

def sourceTheoremBoundary : String := "classical boundary of dynamic games"
